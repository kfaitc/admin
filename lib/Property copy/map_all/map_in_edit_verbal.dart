...
class Map_verbal_edit extends StatefulWidget {
  const Map_verbal_edit({
    super.key,
  ...
  @override
  State<Map_verbal_edit> createState() => _SearchPlacesScreenState();
}

class _SearchPlacesScreenState extends State<Map_verbal_edit> {
  String sendAddrress = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text("KFA's Map on editting"),
      ),
      body: Stack(
        children: [
          SizedBox(
