...
class Map_Sale_Screen extends StatefulWidget {
  const Map_Sale_Screen({
    super.key,
  ...
  @override
  State<Map_Sale_Screen> createState() => _SearchPlacesScreenState();
}

class _SearchPlacesScreenState extends State<Map_Sale_Screen> {
  String sendAddrress = '';
