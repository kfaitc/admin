...
// import 'package:kfa_admin/interface/mobile/navigate_home/Report/Transetoin/personal_user.dart';
...
//                               children: [
//                                 _text(
//                                     'USER ID : ${list[index]['control_user']}',
//                                     9,
//                                     true),
//                                 _text('Name : ${list[index]['username']}', 9,
//                                     false),
//                                 _text('Phone : ${list[index]['tel_num']}', 9,
//                                     false),
//                                 _text(
//                                     'Email : ${list[index]['email']}', 9, false)
//                               ],
//                             ),
//                           )
//                         ],
