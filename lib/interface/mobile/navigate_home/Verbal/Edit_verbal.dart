...
import 'package:kfa_admin/components/slideUp.dart';
import 'package:kfa_admin/interface/mobile/navigate_home/AutoVerbal/property.dart';
...
class EditVerbal extends StatefulWidget {
  const EditVerbal(
      {super.key,
      required this.image,
      required this.user,
  ...
  @override
  State<EditVerbal> createState() => _EditVerbalState();
}

class _EditVerbalState extends State<EditVerbal>
