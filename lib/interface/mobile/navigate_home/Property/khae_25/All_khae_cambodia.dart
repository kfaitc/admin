...
import 'Province_detail_List.dart';
...
class _ALl_Khae_cambodiaState extends State<ALl_Khae_cambodia> {
  ...
  // Future<void> list2_Sale_khae1(property_type_id) async {
  //   // print('list2_Sale_khae1 = $property_type_id');
  //   var jsonData;
  //   final response = await http.get(Uri.parse(
  //       'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/Commune_25/${property_type_id}'));
  ...
  //     setState(() {
  //       list2_Sale_khae;
  //       print('$property_type_id = $list2_Sale_khae');
  //       Get.to(HHHHSSs(value_province: list2_Sale_khae));
  //     });
  //   }
  // }
  ...
  Future<void> Property_Sale_value() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        list2_Sale2;
        // for (int i = 0; i < list2_Sale2.length; i++) {
        //   // print(
        //   //     'phnom penh$i = ${list2_Sale2[i]['property_type_id'].toString()}');
        //   if (list2_Sale2[i]['property_type_id'].toString() == '1') {
        //     print('${list2_Sale2[i]}');
        ...
        // // print(list2_Sale2);
        // if (property_type_id == list2_Sale2[0]['property_type_id'].toString()) {
        // } else {
        //   print('Nonono');
        // }
      });
  ...
  // List? list2_Sale322;
  // Future<void> Property_Sale_image(value) async {
  //   var jsonData;
  //   final response = await http.get(Uri.parse(
