        ...
        actions: <Widget>[
          InkWell(
            onTap: () async {
              ...
              if (type == 'For Sale' && _imageFile != null) {
              ...
              } else if (type == 'For Rent' && _imageFile != null) {
                APi_property apIservice = APi_property();
                apIservice
...
// For Sale***************************************************************
  ...
  Future<File?> _upload_Image_Sale() async {
    ...
    request.files.add(
        await http.MultipartFile.fromPath('image_name_sale', _imageFile!.path));
  ...
  Future<File?> _uploadImage_Rent() async {
    ...
    request.files.add(
        await http.MultipartFile.fromPath('image_name_rent', _imageFile!.path));
