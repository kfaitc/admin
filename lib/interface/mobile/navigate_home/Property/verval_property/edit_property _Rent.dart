...
class _Add_verbal_saleState extends State<Edit_verbal_property_Rent> {
              ...
              onTap: () async {
                ...
                if (type != null) {
                  ...
                  apIservice
                    ...
                    (value) async {
                      setState(() async {
                        (urgent != null) ? urgent_Rent() : null;

                        if (_imageFile_input != null &&
                            mutiple_image == 'Pick') {
                          await _upload_Image_Rent_url();
  ...
  Future<void> _uploadImageRentMultiple() async {
    final url = Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/mutiple_image_update_R_mutiple/${widget.get_all_homeytpe![indexN!]['id_ptys'].toString()}');
  ...
  ////////////////
  Future<File?> _upload_Image_Rent_url() async {
    var tempFile;
    if (_imageFile_input == null) {
