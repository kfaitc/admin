...
import '../Comparable/comparable_1/Edit_Comparable.dart';
...
class _ComparableListState extends State<Customer_List> {
  ...
  // Future<void> Customer_search_id() async {
  //   setState(() {});
  //   try {
  //     final response = await http.get(Uri.parse(
  //         'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/customer_customer_id?search=1722'));
