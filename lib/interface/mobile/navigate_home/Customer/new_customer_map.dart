// ignore_for_file: unused_element, unused_local_variable, unused_field, equal_keys_in_map, unnecessary_null_comparison, unused_catch_clause, null_check_always_fails
...
import '../property/Map/map_in_add_verbal.dart';
...
class _new_customerState extends State<new_customer_map> {
  ...
  void New_Customer() async {
    Map<String, dynamic> payload = await {
      ...
      ////////////////,
      'province_map': provice_map.toString(),
      'district_map': district_map.toString(),
      'cummune_map': cummune_map.toString(),
      ...
      /////?????????????????????????????????????????/////
      'customerpropertyprovince': null,
      'customerpropertydistrict': null,
      'customerpropertycommune': null,
                              ...
                              return Map_verbal_address_Sale(
                                ...
                                get_log: (value) {
                                  setState(() {
                                    log = value.toString();
                                    _log =
                                        TextEditingController(text: '${log}');
                                    log = _log!.text;
                                  });
                                },
                                get_lat: (value) {
                            ...
                            ? Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text('${provice_map}', style: sizefont_map),
                                    SizedBox(
                                      width: 10,
                                    ),
                                    Text('/ ${district_map}',
